...
test(build_import_string)(
    kwargs={"generated_test_file_imports": {("sundew.test_writer", "build_import_string"), ("sundew.test_writer", "build_test_strings"), ("sundew.test_writer", "generate_naive_function_import"), ("sundew.test_writer", "write_tests_to_file")}},
